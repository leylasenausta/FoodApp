...
import com.nostra13.universalimageloader.core.listener.ImageLoadingListener
   ...
   class UniversalImageLoader(private val mContext : Context) {
    ...
    val config:ImageLoaderConfiguration
       ...
       companion object{
           private const val defaultImage= R.drawable.tab_like

           fun setImage(imgUrl:String,imageView:ImageView, mProgressBar:ProgressBar?, ilkKsm:String?){
               val imageLoader=ImageLoader.getInstance()
                   imageLoader.displayImage(ilkKsm+imgUrl, imageView,
